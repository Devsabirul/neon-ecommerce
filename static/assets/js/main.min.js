                  ...
                  setTimeout(function () {
                    i.removeClass("load-more-overlay loading"),
                      havetic.Minipopup.open({
                        ...
                        actionTemplate:
                          '<a href="/cart" class="btn btn-rounded btn-sm">View Cart</a><a href="/checkout" class="btn btn-dark btn-rounded btn-sm">Checkout</a>',
                      });
                  }, 500));
            }
          ),
          ...
          (function () {
            ...
            a.length ||
              ...
              (t(".page-wrapper").append(
                '<div class="compare-popup">                    <div class="container">                        <div class="compare-title">                            <h4 class="title title-center">Compare Products</h4>                        </div>                        <ul class="compare-product-list list-style-none">                            <li></li><li></li><li></li><li></li>                        </ul>                        <a href="#" class="btn btn-clean">Clean All</a>                        <a href="#" class="btn btn-dark btn-rounded">Start Compare !</a>                    </div>                </div>                <div class="compare-popup-overlay">                </div>'
              ),
              (a = t(".page-wrapper > .compare-popup"))),
              havetic.$body
